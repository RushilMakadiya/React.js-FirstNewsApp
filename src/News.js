                            ...
                            <div className='col-md-4' key={i}>
                                <div className="card" style={{ marginBottom: '20px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2)' }}>
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title" style={{ color:'black'}}>{v.source.name}</h5>
                                        <h5 className="card-title" style={{ color:'black'}}>{v.title}</h5>
                                        <p className="card-text" style={{ color:'grey'}}>{v.description}</p>
